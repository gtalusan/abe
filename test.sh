...
match='checking           glibc newlib gcc gdb'
test_pass "${cb_commands}" "${match}"
...
match='checking           glibc newlib gcc'
test_pass "${cb_commands}" "${match}"
...
match='checking           glibc newlib binutils'
test_pass "${cb_commands}" "${match}"
